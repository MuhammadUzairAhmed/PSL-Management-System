...
<body>
<section id="ext_menu-2a" data-rv-view="546">
...
<section class="engine"><a href="https://mobirise.co/c">web page maker</a></section><section class="mbr-section article mbr-parallax-background mbr-after-navbar" id="msg-box8-27" data-rv-view="534" style="background-image: url(assets/images/cricket-ball-by-hedgehog-the-hermit-d6sqiom-1600x973.jpg); padding-top: 80px; padding-bottom: 80px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 class="mbr-section-title display-2">BOWLING COACH</h3>
...
<section class="mbr-section mbr-section__container article" id="header3-3i" data-rv-view="1160" style="background-color: rgb(255, 255, 255); padding-top: 20px; padding-bottom: 20px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
...
<section class="mbr-section article mbr-parallax-background" id="msg-box3-28" data-rv-view="537" style="background-image: url(assets/images/k-1600x1132.jpg); padding-top: 120px; padding-bottom: 120px;">
...
<?php
		...
		$coach = "select * from bowlcoach where COID = '$y'";
	...
	//this is for boughtd coach
		$send_into_bought_coach = "insert into bought_bowl_coach(SID,COID) values('$sponsor_id','$y')";
		$BoughtPlayers = mysqli_query($con,$send_into_bought_coach);
//		echo "<script>alert('coach bought')</script>";
	
	     	
			$check = "select count(COID) AS total from bought_bowl_coach  where SID = '$sponsor_id' ";
...
$try = $Crun['total'];
  //		echo "<script>alert('$try')</script>";
	...
	echo "<script>alert('you cannot bought '+ '$try' + ' bowling coaches')</script>";
...
{	
		...
		//update sponsors budget
		$updateSponsorsBudget = "update bought_players set COID = '$y' ,BowlingCoach = '$coachName' where SID='$sponsor_id'";
		$updated = mysqli_query($con,$updateSponsorsBudget);
		//echo "<script>alert('coach updated')</script>";
		
		
		//delete players after bought
		$deletePlayer = "delete from bowlcoach where COID='$y'";
		$deleted = mysqli_query($con,$deletePlayer);
		echo "<script>alert('you successfully bought '+ '$try' + ' bowling coach')</script>";
	echo "<script>window.open('bowlCoach.php?inserted=a new page insert','_self')</script>";
}
else
{
echo "<script>alert('u dont have enoigh money to buy coach')</script>";
}
...
<section class="mbr-section mbr-section-md-padding mbr-footer footer1" id="contacts1-2b" data-rv-view="548" style="background-color: rgb(0, 0, 0); padding-top: 30px; padding-bottom: 30px;">
...
<footer class="mbr-small-footer mbr-section mbr-section-nopadding" id="footer1-2c" data-rv-view="550" style="background-color: rgb(0, 0, 0); padding-top: 1.75rem; padding-bottom: 1.75rem;">
